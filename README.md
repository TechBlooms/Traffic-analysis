...
# 04 Overview of the project <a name = "overview"></a>
...
# 05 Implementation - Algorithm <a name = "alg"></a>
...
# 06 Deployment of OneAPI <a name = "oneapi"></a>
...
# 07 Output - Count taken <a name = "op"></a>
